...
var ScheduleEditComponent = (function () {
    function ScheduleEditComponent(route, router, dataService, itemsService, notificationService, configService, mappingService) {
        this.route = route;
        this.router = router;
    ...
    ScheduleEditComponent = __decorate([
        ...
        __metadata('design:paramtypes', [router_1.ActivatedRoute, router_1.Router, data_service_1.DataService, items_service_1.ItemsService, notification_service_1.NotificationService, config_service_1.ConfigService, mapping_service_1.MappingService])
